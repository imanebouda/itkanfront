...
@Component({
  selector: 'app-add-proces-objectifs',
  templateUrl: './add-proces-objectifs.component.html',
})
export class AddProcesObjectifsComponent {
...
CallAddApi() {
 ...
 this.Ajouter = this.processusObjectifs_src.InsertProcesObjectifs(this.clientForm.value)
   .subscribe((r: any) => {
     r = JSON.parse(r);
