...
@Component({
  selector: 'app-update-document-procedure',
  templateUrl: './update-document-procedure.component.html',
  styleUrls: ['./update-document-procedure.component.scss']
})
export class UpdateDocumentProcedureComponent {
...
ngOnInit(): void { 
  ...
  this.UpdateclientForm.get('ProcID')?.setValue(this.data_selected_Dp.parent.parent.key);
}
