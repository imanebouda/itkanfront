...
@Component({
  selector: 'app-add-politique-qualite',
  templateUrl: './add-politique-qualite.component.html',
  styleUrls: ['./add-politique-qualite.component.scss']
})
export class AddPolitiqueQualiteComponent {
    ...
    CallAddApi() {
        ...
        this.Ajouter = this.politiqueQualite_src.InsertPQdocuments(formData)
