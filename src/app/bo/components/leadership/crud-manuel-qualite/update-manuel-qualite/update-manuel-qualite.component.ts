...
@Component({
  selector: 'app-update-manuel-qualite',
  templateUrl: './update-manuel-qualite.component.html',
  styleUrls: ['./update-manuel-qualite.component.scss']
})
export class UpdateManuelQualiteComponent {
...
callUpdateApi() {
  ...
  this.Ajouter = this.manuelQualite_src.UpdateMQDocuments(formData)
