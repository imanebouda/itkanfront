...
@Component({
  selector: 'app-update-proces-documents',
  templateUrl: './update-proces-documents.component.html',
  styleUrls: ['./update-proces-documents.component.scss']
})
export class UpdateProcesDocumentsComponent {
...
ngOnInit(): void {
  ...
  this.UpdateclientForm.get('ProcessusID')?.setValue(this.data_selected_Dp.ProcessusID);
}
