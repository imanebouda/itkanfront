...
@Component({
  selector: 'app-update-resultat-indicateur',
  templateUrl: './update-resultat-indicateur.component.html',
  styleUrls: ['./update-resultat-indicateur.component.scss']
})
export class UpdateResultatIndicateurComponent {
...
ngOnInit(): void {
  ...
  this.UpdateclientForm.get('Periode')?.setValue(this.data_selected_ddp.Periode);
  this.UpdateclientForm.get('Resultat')?.setValue(this.data_selected_ddp.Resultat);
  this.UpdateclientForm.get('Annee')?.setValue(this.data_selected_ddp.Annee);
  this.UpdateclientForm.get('IndicateurID')?.setValue(IndicateurID);
