...
@Component({
  selector: 'app-add-proc-documents',
  templateUrl: './add-proc-documents.component.html',
  styleUrls: ['./add-proc-documents.component.scss'],
  providers: [MessageService]
})
export class AddProcDocumentsComponent {
